...
public class OkUtils {
    ...
    public static OkUtils.SSLParams getSslSocketFactory(InputStream[] certificates, InputStream bksFile, String password) {
        OkUtils.SSLParams sslParams = new OkUtils.SSLParams();
        ...
        try {
            ...
            if(e != null) {
                trustManager = new OkUtils.MyTrustManager(chooseTrustManager(e));
            } else {
                trustManager = new OkUtils.UnSafeTrustManager();
            }
    ...
    private static class MyTrustManager implements X509TrustManager {
        ...
        public MyTrustManager(X509TrustManager localTrustManager) throws NoSuchAlgorithmException, KeyStoreException {
            ...
            this.defaultTrustManager = OkUtils.chooseTrustManager(var4.getTrustManagers());
